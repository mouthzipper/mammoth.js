...
function simpleWriter() {
    function element(node, assetsArray, parentEl) {
        ...
        // console.log('element parent El', JSON.stringify(parentEl, null, 4));
        // console.log('child node', JSON.stringify(node, null, 3));
        ...
        if(tagName === 'image') {
            ...
            if(TEXT_STYLE_TAGS.includes(tagName)) {
                ...
                // console.log('pr', parentEl.nodes[trIndex].nodes[tdIndex].nodes[[pIndex]])
            ...
            if(tagName === 'listItem') {
                const tdIndex = parentEl.nodes[trIndex].nodes.length === 0 ? 0 : parentEl.nodes[trIndex].nodes.length -1;
                const pIndex = parentEl.nodes[trIndex].nodes[tdIndex].nodes.length === 0 ? 0 : parentEl.nodes[trIndex].nodes[tdIndex].nodes.length - 1;
                // console.log('pea', JSON.stringify(parentEl.nodes[trIndex].nodes[tdIndex], null, 4));
        ...
        if(parentEl && parentEl.nodes && Array.isArray(parentEl.nodes)) {
            ...
            if(isTable) {
                ...
                if(pEl.type === 'bulletList') {
                    ...
                    if(childEl) {
                        childEl.nodes[0].text = value;
                        childEl.nodes[0].object = 'text';
                    } else {
                ...
                } else if(pEl && _.has(pEl.nodes[pElIndex], 'marks')) {
                    pEl.nodes[pElIndex].text = value;
                } else if(pEl && pEl.nodes) {
            ...
            } else if(parentEl.nodes.length > 0 && value.length > 1) {
